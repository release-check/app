...
const SCENE_MAP: Record<string, string> = {
  ...
  "mb-ingest-bts-spring-day": "korea",
  "mb-ingest-blackpink-how-you-like-that": "korea",
  "mb-ingest-blackpink-kill-this-love": "korea",
  "mb-ingest-red-velvet-psycho": "korea",
  "mb-ingest-aespa-savage": "korea",
  "mb-ingest-ive-love-dive": "korea",
  "mb-ingest-iu-blueming": "korea",
  "mb-ingest-twice-fancy": "korea",
  "mb-ingest-newjeans-omg": "korea",
  "mb-ingest-yerin-baek-maybe-it-s-not-our-fault": "korea",
  "mb-ingest-yaeji-raingurl": "korea",
  "mb-ingest-kenshi-yonezu-kick-back": "japan",
  "mb-ingest-kenshi-yonezu-loser": "japan",
  "mb-ingest-hikaru-utada-automatic": "japan",
  "mb-ingest-ryokuoushoku-shakai-shout-baby": "japan",
  "mb-ingest-king-gnu-specialz": "japan",
  "mb-ingest-ado-usseewa": "japan",
  "mb-ingest-vaundy-kaijuu-no-hanauta": "japan",
  "mb-ingest-yumi-matsutoya-haru-yo-koi": "japan",
  "mb-ingest-mrs-green-apple-inferno": "japan",
  "mb-ingest-jon-hopkins-emerald-rush": "internet",
  "mb-ingest-dorian-electra-adam-steve": "internet",
  "mb-ingest-slayyyter-mine": "internet",
  "mb-ingest-tommy-genesis-100-bad": "internet",
  "mb-ingest-four-tet-two-thousand-and-seventeen": "internet",
  "mb-ingest-kero-kero-bonito-sick-beat": "internet",
  "mb-ingest-100-gecs-money-machine": "internet",
  "mb-ingest-jamie-xx-gosh": "internet",
  "mb-ingest-arca-nonbinary": "internet",
  "mb-ingest-rico-nasty-ohfr": "internet",
  "mb-ingest-charli-xcx-von-dutch": "internet",
  "mb-ingest-charli-xcx-track-10": "internet",
  "mb-ingest-bonobo-kerala": "internet",
  "mb-ingest-kim-petras-i-don-t-want-it-at-all": "internet",
};
